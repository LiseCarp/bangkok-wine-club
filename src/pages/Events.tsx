  ...
  const events = [
    {
      ...
      excerpt: "An evening dedicated to the elegance of French Burgundy wines, featuring exceptional Pinot Noirs from renowned domaines across Côte d'Or.",
